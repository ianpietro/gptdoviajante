...
Se o usuário estiver informando preferências ou a composição do grupo, gere ações preferences/update salvando destino, tripTitle, start_date, end_date, traveler_count e travelers_detail ({adults, children, child_ages, group_type, summary_label}).
...
Preserve todas as propriedades ricas do roteiro nas atividades (dayStory, highlight, localSecret, logistics, climate_plan, restaurant_options, address, location, price_level, why, zone, duration, travel_time, opening_hours, reservation_required, estimated_cost, practical_tips). Não invente ações fora do que já foi entregue. Não inclua id, ownership ou auth.
